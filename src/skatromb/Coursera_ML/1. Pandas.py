...
print('2: \n'
      '{:.2f}'.format(float(data['Survived'].sum() / data.shape[0]).__round__(4) * 100),
      end='\n'*3)


print('3: \n'
      '{:.2f}'.format(float(data['Pclass'].value_counts()[1] / data.shape[0]).__round__(4) * 100),
      end='\n'*3)
...
print('{:.2f}'.format(float(data['Age'].median()).__round__(4)),
      end=' ')


print('5: \n'
      '{:.2f}'.format(float(data['SibSp'].corr(other=data['Parch'], method='pearson')).__round__(4)),
      end='\n'*3)
