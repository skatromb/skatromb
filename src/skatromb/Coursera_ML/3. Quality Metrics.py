...
print(f'{accuracy_score(target, y):.2f} {precision_score(target, y):.2f} {recall_score(target, y):.2f} {f1_score(target, y):.2f}')
...
print(' '.join('{:.2f}'.format(value) for value in roc_auc_scores))
